...
class TestMQCommunication_myProducer5(TestMQCommunication):
  def setUp(self):
    MQComm.connectionManager.removeAllConnections()
  ...
  def test_success(self, mock_getMQParamsFromCS):
    ...
    # for i in xrange(20):
      ...
      # result = producer.close()
      # self.assertTrue(result['OK'])
    producers = [createProducer(mqURI='mardirac3.in2p3.fr::Queue::test1')['Value'] for _ in xrange(20)]
    for p in producers:
      p.put("aaa")
    time.sleep(11)
...
if __name__ == '__main__':
  ...
  suite.addTest(unittest.defaultTestLoader.loadTestsFromTestCase(TestMQCommunication_myProducer5))
